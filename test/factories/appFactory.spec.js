...
module.exports = function() {
  ddescribe('appFactory.js', function() {
    ...
    describe('findDistances', function() {
      var findDistances = factory.findDistances;
      var userCoords = [ '1', '2' ];
    ...
    describe('connectStationsWithPlugsAndSponsors', function() {
      var connectStationsWithPlugsAndSponsors = factory.connectStationsWithPlugsAndSponsors;
      var stations = [];
      var plugs = [];
    ...
    describe('attachImages', function() {
      var attachImages = factory.attachImages;
    ...
    describe('groupByKin', function() {
      var groupByKin = factory.groupByKin;
      ...
      it('should count stations as availabile if we otherwise don\'t know', function() {
        spyOn( factory, 'countStationAvailability' ).andCallThrough();
        delete stationsWithPlugs[ 0 ].in_use;
        stationsWithPlugs[ 1 ].in_use = [ 'true' ];
        var result = groupByKin( stationsWithPlugs );
        expect( factory.countStationAvailability.calls.length ).toBe( 1 );
        expect( factory.countStationAvailability ).toHaveBeenCalledWith( [ 'true' ] );
